...
export default function Capabilities({
  ...
  const updateHeader = (field: keyof CapabilitiesData, value: string) => {
            ...
            <div className="space-y-3 text-left">
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => updateHeader('eyebrow', e.target.value)}
                />
              </div>
              <div>
                <label className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground">
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => updateHeader('heading', e.target.value)}
                />
              </div>
              <div>
                <label className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground">
                ...
                <textarea
                  ...
                  onChange={(e: ChangeEvent<HTMLTextAreaElement>) => updateHeader('sub', e.target.value)}
                />
              </div>
            </div>
          ) : (
