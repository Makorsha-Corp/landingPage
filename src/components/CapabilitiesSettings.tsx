...
interface CapabilitiesSettingsProps {
  card: CapabilityCard
  onChange: (updated: CapabilityCard) => void
}
...
export default function CapabilitiesSettings({ card, onChange }: CapabilitiesSettingsProps) {
  const updateField = <K extends keyof CapabilityCard>(field: K, value: CapabilityCard[K]) => {
