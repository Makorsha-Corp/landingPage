...
function FeatureIcon({ path, className = 'h-6 w-6' }: FeatureIconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
function ScreenshotSlot({ card }: ScreenshotSlotProps) {
...
function TextBlock({ card }: TextBlockProps) {
  return (
    <div>
...
interface FeatureCardDialogProps {
