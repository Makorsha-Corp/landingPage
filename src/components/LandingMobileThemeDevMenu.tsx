...
interface LandingMobileThemeDevMenuProps {
  devToolsProps?: DevToolsProps
  collectFeedbackReport?: () => Promise<string>
}

export default function LandingMobileThemeDevMenu({ devToolsProps, collectFeedbackReport }: LandingMobileThemeDevMenuProps) {
            ...
            <div className="fixed inset-0 z-[110] md:hidden" role="presentation">
              ...
              >
                <button
                  type="button"
                  role="menuitem"
                  onClick={(event: ReactMouseEvent<HTMLButtonElement>) => toggleTheme(event)}
