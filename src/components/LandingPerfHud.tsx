...
interface LandingPerfHudProps {
  enabled?: boolean
  tourMetricsRef?: RefObject<TourMetrics | null>
  heroActive?: boolean
...
export default function LandingPerfHud({
  ...
  return createPortal(
    ...
    >
      ...
      <div>
        stop {activeIndex} · copy {mobileTourCopyVisible ? 'on' : 'off'} · wash{' '}
