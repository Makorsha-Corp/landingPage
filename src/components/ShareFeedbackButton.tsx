...
interface ShareFeedbackReportSheetProps {
  open: boolean
  reportText: string
  copyState: CopyState
  onCopy: () => void
...
function ShareFeedbackReportSheet({ open, reportText, copyState, onCopy, onClose }: ShareFeedbackReportSheetProps) {
...
interface ShareFeedbackButtonProps {
  collectReport?: () => Promise<string | null | undefined>
  className?: string
