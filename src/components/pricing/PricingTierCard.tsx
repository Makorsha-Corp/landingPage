...
import type { RefObject, CSSProperties, MouseEvent as ReactMouseEvent } from 'react'
...
interface PresentationStyles {
  ...
  showBadge: (tier: PricingTier) => boolean
  badgeWrap: string
  badge: string
  title: string
  price: string
  ...
  iconTile: string
  featureText: string
  featureListSpacing: string
  foldToggle: string
  buttonVariant: (tier: PricingTier) => ButtonVariant
}

const PRESENTATION_STYLES: Record<string, PresentationStyles> = {
  default: {
    ...
    showBadge: (tier) => Boolean(tier.highlighted),
...
function FeatureRow({ feature, iconTileClass, featureTextClass, rowRef }: FeatureRowProps) {
  return (
...
interface PricingTierCardProps {
  ...
  presentation?: 'default' | 'mobileHero' | 'mobileMuted'
  foldFeatures?: boolean
...
export default function PricingTierCard({
  ...
  const handleCtaClick = (event: ReactMouseEvent<HTMLButtonElement | HTMLAnchorElement>) => {
