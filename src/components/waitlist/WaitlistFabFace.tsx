...
export interface WaitlistFabFaceProps {
  styleId?: string
...
const WaitlistFabFace = forwardRef<HTMLButtonElement, WaitlistFabFaceProps>(
  function WaitlistFabFace({ styleId = 'pill_rainbow', variant = 'brand', onClick, className }, ref) {
