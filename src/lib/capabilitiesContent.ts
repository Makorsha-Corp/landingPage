...
function isLegacyCapabilitiesEyebrow(value: string | undefined | null): boolean {
  return typeof value !== 'string' || value.trim().toLowerCase() === 'capabilities'
}

export function normalizeCapabilitiesEyebrow(value: string | undefined | null): string {
  return isLegacyCapabilitiesEyebrow(value) ? DEFAULT_CAPABILITIES.eyebrow : value!
}

function mergeCardFromSaved(
  defaults: CapabilityCard,
  savedCard: Partial<CapabilityCard> | undefined,
): CapabilityCard {
...
export function cloneCapabilities(source: Capabilities): Capabilities {
  return {
    ...source,
...
export function mergeCapabilitiesFromSaved(saved: Partial<Capabilities> | null | undefined): Capabilities {
...
export function capabilitiesForStorage(capabilities: Capabilities): Capabilities {
  return {
