export interface StoryCardStyles {
  card: string
  glass: string
  title: string
  desc: string
...
export function getStoryGlassShell(theme: string): string {
  if (theme === 'dark') {
...
export interface StoryCardTextClasses {
  title: string
  desc: string
}

/** Text classes for story/feature cards (no theme param = light default). */
export function getStoryCardTextClasses(theme: string): StoryCardTextClasses {
  if (theme === 'dark') {
...
export function getStoryCardStyles(theme: string): StoryCardStyles {
  if (theme === 'dark') {
    return {
...
export function getStoryCardInteractiveClasses(theme: string): string {
  const shared =
...
export function getStoryCardArrowPillClasses(theme: string): string {
  const shared =
...
export function getStoryCardElevatedClasses(theme: string): string {
...
export function getStoryCardStaticClasses(theme: string): string {
  const { card: cardCls } = getStoryCardStyles(theme)
