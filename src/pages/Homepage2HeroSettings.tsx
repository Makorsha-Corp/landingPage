...
interface Homepage2HeroSettingsProps {
  hero: HeroContent
  onChange: (updated: HeroContent) => void
}
...
export default function Homepage2HeroSettings({ hero, onChange }: Homepage2HeroSettingsProps) {
  const update = <K extends keyof HeroContent>(field: K, value: HeroContent[K]) => {
