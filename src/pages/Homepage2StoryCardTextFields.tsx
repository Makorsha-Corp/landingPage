...
interface Homepage2StoryCardTextFieldsProps {
  stop: TourStop
  onChange: (updated: TourStop) => void
}
...
export default function Homepage2StoryCardTextFields({ stop, onChange }: Homepage2StoryCardTextFieldsProps) {
  const updateField = <K extends keyof TourStop>(field: K, value: TourStop[K]) => {
